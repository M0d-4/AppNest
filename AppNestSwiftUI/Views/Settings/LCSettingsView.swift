...
enum JITEnablerType : Int, CaseIterable, Identifiable {
    ...
    var displayName: String {
        ...
        case .StikJITLC: "StikDebug (Another AppNest)"
        case .StosDebug: "StosDebug"
        case .StosDebugLC: "StosDebug (Another AppNest)"
...
struct LCSettingsView: View {
    ...
    func openGitHub() {
        UIApplication.shared.open(URL(string: "https://github.com/AppNest/AppNest")!)
    }
    ...
    func importCertificateFromSideStore() async {
        if UserDefaults.sideStoreExist() {
            if let ans = await certificateImportFromBuiltInSideStoreAlert.open(), ans {
                let query: [String: Any] = [
                    ...
                    kSecAttrService as String: "com.kdt.appnest",
        ...
        guard let url = URL(string: "\(storeScheme.lowercased())://certificate?callback_template=appnest%3A%2F%2Fcertificate%3Fcert%3D%24%28BASE64_CERT%29%26password%3D%24%28PASSWORD%29") else {

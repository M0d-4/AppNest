...
private let knownAppNests = [
    LaunchPriorityLC(scheme: "appnest", displayName: "AppNest"),
    LaunchPriorityLC(scheme: "appnest2", displayName: "AppNest2"),
    LaunchPriorityLC(scheme: "appnest3", displayName: "AppNest3")
]
...
struct LCMultiLCManagementView : View, InstallAnotherLCButtonDelegate {
    ...
    private func reloadLaunchPriorityItems() {
        let installedItems = knownAppNests.filter { isInstalled(scheme: $0.scheme) }

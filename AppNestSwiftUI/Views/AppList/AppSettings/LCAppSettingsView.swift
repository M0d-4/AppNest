...
struct LCAppSettingsView: View {
    ...
    @ViewBuilder private var settingsSecuritySections: some View {
            // MARK: Security Section
            Section {
                Toggle(isOn: $model.uiHideAppNest) {
                    Text("lc.appSettings.hideAppNest".loc)
                }
    ...
    @ViewBuilder private var settingsLockSections: some View {
            Section {
    ...
    @ViewBuilder private var settingsBottomSections: some View {
            Section {
...
func lcClearAppCacheAndTemp(bundlePath: String, containerTargets: [LCAppContainerTarget]) throws -> LCCacheCleanupResult {
    ...
    cleanupResult = cleanupResult + (try lcRemoveItemIfExists(at: bundleURL.appendingPathComponent("AppNest.tmp")))

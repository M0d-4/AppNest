...
static NSURL *LCBaseGroupContainerURL(void) {
    ...
    if (NSUserDefaults.lcAppGroupPath.length > 0) {
        return [NSURL fileURLWithPath:[NSUserDefaults.lcAppGroupPath stringByAppendingPathComponent:@"AppNest/Data/AppGroup"] isDirectory:YES];
    }
...
@implementation NSFileManager(AppNestHooks)

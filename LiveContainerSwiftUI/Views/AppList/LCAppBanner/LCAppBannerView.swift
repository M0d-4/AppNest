...
final class LCAppBannerRootView: UIView {
    ...
    private func setupView() {
        ...
        configureLabel(locationLabel, font: .systemFont(ofSize: 12))
    ...
    func update(
        ...
        containerLabel.textColor = .systemBlue

        if model.uiSelectedContainer != nil && model.uiSpoofGPS {
            locationLabel.isHidden = false
            locationLabel.text = "📍 \(Self.locationDisplayText(model: model))"
        } else {
        ...
        cameraSpoofBadge.isHidden = !model.uiSpoofCamera
    ...
    private static func locationDisplayText(model: LCAppModel) -> String {
...
private final class LCAppBannerBadgeView: UIView {
    ...
    convenience init(symbolName: String, tint: UIColor = .white) {
